...
MovieInfoService_GetMoviesByName_args::~MovieInfoService_GetMoviesByName_args() noexcept {
}


uint32_t MovieInfoService_GetMoviesByName_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t MovieInfoService_GetMoviesByName_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("MovieInfoService_GetMoviesByName_args");

  xfer += oprot->writeFieldBegin("title", ::apache::thrift::protocol::T_I64, 1);
  xfer += oprot->writeI64(this->title);
  xfer += oprot->writeFieldEnd();
...
MovieInfoService_GetMoviesByName_pargs::~MovieInfoService_GetMoviesByName_pargs() noexcept {
}


uint32_t MovieInfoService_GetMoviesByName_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("MovieInfoService_GetMoviesByName_pargs");
...
MovieInfoService_GetMoviesByName_result::~MovieInfoService_GetMoviesByName_result() noexcept {
}


uint32_t MovieInfoService_GetMoviesByName_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t MovieInfoService_GetMoviesByName_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("MovieInfoService_GetMoviesByName_result");
...
MovieInfoService_GetMoviesByName_presult::~MovieInfoService_GetMoviesByName_presult() noexcept {
}


uint32_t MovieInfoService_GetMoviesByName_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
void MovieInfoServiceClient::GetMoviesByName(std::vector<std::string> & _return, const int64_t title)
{
  send_GetMoviesByName(title);
  recv_GetMoviesByName(_return);
}

void MovieInfoServiceClient::send_GetMoviesByName(const int64_t title)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("GetMoviesByName", ::apache::thrift::protocol::T_CALL, cseqid);

  MovieInfoService_GetMoviesByName_pargs args;
  args.title = &title;
  args.write(oprot_);
...
void MovieInfoServiceClient::recv_GetMoviesByName(std::vector<std::string> & _return)
{
  ...
  if (fname.compare("GetMoviesByName") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  MovieInfoService_GetMoviesByName_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
  ...
  throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT, "GetMoviesByName failed: unknown result");
}
...
void MovieInfoServiceProcessor::process_GetMoviesByName(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
    ctx = this->eventHandler_->getContext("MovieInfoService.GetMoviesByName", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "MovieInfoService.GetMoviesByName");

  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->preRead(ctx, "MovieInfoService.GetMoviesByName");
  }

  MovieInfoService_GetMoviesByName_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->postRead(ctx, "MovieInfoService.GetMoviesByName", bytes);
  }

  MovieInfoService_GetMoviesByName_result result;
  try {
    iface_->GetMoviesByName(result.success, args.title);
    result.__isset.success = true;
    ...
    if (this->eventHandler_.get() != nullptr) {
      this->eventHandler_->handlerError(ctx, "MovieInfoService.GetMoviesByName");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("GetMoviesByName", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->preWrite(ctx, "MovieInfoService.GetMoviesByName");
  }

  oprot->writeMessageBegin("GetMoviesByName", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->postWrite(ctx, "MovieInfoService.GetMoviesByName", bytes);
  }
}
...
void MovieInfoServiceConcurrentClient::GetMoviesByName(std::vector<std::string> & _return, const int64_t title)
{
  int32_t seqid = send_GetMoviesByName(title);
  recv_GetMoviesByName(_return, seqid);
}

int32_t MovieInfoServiceConcurrentClient::send_GetMoviesByName(const int64_t title)
{
  int32_t cseqid = this->sync_->generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(this->sync_.get());
  oprot_->writeMessageBegin("GetMoviesByName", ::apache::thrift::protocol::T_CALL, cseqid);
...
void MovieInfoServiceConcurrentClient::recv_GetMoviesByName(std::vector<std::string> & _return, const int32_t seqid)
{
