...
class MovieInfoServiceIf {
 public:
  ...
  virtual void GetMoviesByName(std::vector<std::string> & _return, const int64_t title) = 0;
};
...
class MovieInfoServiceNull : virtual public MovieInfoServiceIf {
 public:
  ...
  void GetMoviesByName(std::vector<std::string> & /* _return */, const int64_t /* title */) {
    return;
  }
};
...
typedef struct _MovieInfoService_GetMoviesByName_args__isset {
  _MovieInfoService_GetMoviesByName_args__isset() : title(false) {}
  bool title :1;
} _MovieInfoService_GetMoviesByName_args__isset;

class MovieInfoService_GetMoviesByName_args {
 public:

  MovieInfoService_GetMoviesByName_args(const MovieInfoService_GetMoviesByName_args&);
  MovieInfoService_GetMoviesByName_args& operator=(const MovieInfoService_GetMoviesByName_args&);
  MovieInfoService_GetMoviesByName_args() : title(0) {
  }

  virtual ~MovieInfoService_GetMoviesByName_args() noexcept;
  int64_t title;

  _MovieInfoService_GetMoviesByName_args__isset __isset;

  void __set_title(const int64_t val);

  bool operator == (const MovieInfoService_GetMoviesByName_args & rhs) const
  {
    if (!(title == rhs.title))
      return false;
    return true;
  ...
  bool operator < (const MovieInfoService_GetMoviesByName_args & ) const;
...
class MovieInfoService_GetMoviesByName_pargs {
 public:


  virtual ~MovieInfoService_GetMoviesByName_pargs() noexcept;
  const int64_t* title;
...
typedef struct _MovieInfoService_GetMoviesByName_result__isset {
  _MovieInfoService_GetMoviesByName_result__isset() : success(false), se(false) {}
  bool success :1;
  bool se :1;
} _MovieInfoService_GetMoviesByName_result__isset;

class MovieInfoService_GetMoviesByName_result {
 public:

  MovieInfoService_GetMoviesByName_result(const MovieInfoService_GetMoviesByName_result&);
  MovieInfoService_GetMoviesByName_result& operator=(const MovieInfoService_GetMoviesByName_result&);
  MovieInfoService_GetMoviesByName_result() {
  }

  virtual ~MovieInfoService_GetMoviesByName_result() noexcept;
  std::vector<std::string>  success;
  ServiceException se;

  _MovieInfoService_GetMoviesByName_result__isset __isset;

  void __set_success(const std::vector<std::string> & val);

  void __set_se(const ServiceException& val);

  bool operator == (const MovieInfoService_GetMoviesByName_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(se == rhs.se))
  ...
  bool operator < (const MovieInfoService_GetMoviesByName_result & ) const;
...
typedef struct _MovieInfoService_GetMoviesByName_presult__isset {
  _MovieInfoService_GetMoviesByName_presult__isset() : success(false), se(false) {}
  bool success :1;
  bool se :1;
} _MovieInfoService_GetMoviesByName_presult__isset;

class MovieInfoService_GetMoviesByName_presult {
 public:


  virtual ~MovieInfoService_GetMoviesByName_presult() noexcept;
  std::vector<std::string> * success;
  ServiceException se;

  _MovieInfoService_GetMoviesByName_presult__isset __isset;
...
class MovieInfoServiceClient : virtual public MovieInfoServiceIf {
 ...
 public:
  ...
  void GetMoviesByName(std::vector<std::string> & _return, const int64_t title);
  void send_GetMoviesByName(const int64_t title);
  void recv_GetMoviesByName(std::vector<std::string> & _return);
 protected:
...
class MovieInfoServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 private:
  ...
  void process_GetMoviesByName(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
 public:
  MovieInfoServiceProcessor(::std::shared_ptr<MovieInfoServiceIf> iface) :
    ...
    processMap_["GetMoviesByName"] = &MovieInfoServiceProcessor::process_GetMoviesByName;
  }
...
class MovieInfoServiceMultiface : virtual public MovieInfoServiceIf {
 ...
 public:
  ...
  void GetMoviesByName(std::vector<std::string> & _return, const int64_t title) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->GetMoviesByName(_return, title);
    }
    ifaces_[i]->GetMoviesByName(_return, title);
    return;
  }
  ...
  MovieInfoServiceConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
 ...
 public:
  ...
  void GetMoviesByName(std::vector<std::string> & _return, const int64_t title);
  int32_t send_GetMoviesByName(const int64_t title);
  void recv_GetMoviesByName(std::vector<std::string> & _return, const int32_t seqid);
 protected:
  std::shared_ptr< ::apache::thrift::protocol::TProtocol> piprot_;
  std::shared_ptr< ::apache::thrift::protocol::TProtocol> poprot_;
  ::apache::thrift::protocol::TProtocol* iprot_;
